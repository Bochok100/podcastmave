...
# ХАК: Запускаем виртуальный экран в фоне (&), привязываем DISPLAY и честно стартуем бота
CMD Xvfb :99 -screen 0 1366x768x24 -ac & export DISPLAY=:99 && python -u bot.py
